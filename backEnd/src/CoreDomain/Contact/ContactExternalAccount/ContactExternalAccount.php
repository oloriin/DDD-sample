<?php
namespace CoreDomain\Contact\ContactExternalAccount;
 ...
 * @ORM\Entity(repositoryClass="CoreDomainBundle\Repository\PostgresContactExternalAccountRepository")
 */
class ContactExternalAccount implements Normalized
{
    ...
    /**
     * @var Company
     * @ORM\ManyToOne(targetEntity="CoreDomain\Company\Company" )
