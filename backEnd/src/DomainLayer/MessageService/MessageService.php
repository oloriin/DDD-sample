 ...
 * @ORM\Entity(repositoryClass="InfrastructureLayerBundle\Repository\PostgresMessageServiceRepository")
 */
class MessageService implements Normalized
{
    ...
    /**
     * @var Company
     * @ORM\ManyToOne(targetEntity="DomainLayer\Company\Company" ,cascade={"persist"})
